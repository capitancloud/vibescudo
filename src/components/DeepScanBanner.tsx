            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold uppercase tracking-wider text-primary">Deep Scan</span>
                  <span className="rounded-full bg-primary px-2 py-0.5 text-[10px] font-bold text-primary-foreground">PRO</span>
                </div>
                <h3 className="font-display text-lg sm:text-xl font-bold mb-1">
                  Vuoi una sicurezza di livello superiore?
                </h3>
                <p className="text-sm text-muted-foreground">
                  Penetration test avanzato: SQL Injection, XSS, authentication bypass e molto altro. Consulenza su misura.
                </p>
              </div>
