    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 z-[70] mx-auto max-w-2xl rounded-2xl border border-border bg-card/95 backdrop-blur-xl p-5 shadow-2xl"
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={accept}
                className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-red px-4 py-2 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity"
              >
                Ho capito
              </button>
              <button
